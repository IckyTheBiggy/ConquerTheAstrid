...
namespace Core
{
    public class AudioManager : MonoBehaviour
    {
        ...
        private void SetupAudioSource(AudioSource src, SoundItem soundItem, float pitch)
        {
            ...
            src.spatialBlend = soundItem.SpatialBlend; //Add the if check for settings here
            src.minDistance = -GameManager.Instance.PlanetManagerScript.CurrentPlanet.ZoomMax - 25;
            src.maxDistance = -GameManager.Instance.PlanetManagerScript.CurrentPlanet.ZoomMin + 25;
        }
